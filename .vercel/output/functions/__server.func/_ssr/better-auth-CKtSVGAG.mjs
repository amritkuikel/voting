...
import { n as toKebabCase, t as capitalizeFirstLetter } from "./string-Bx-0C9B2.mjs";
import { a as getBaseURL, d as isSafeUrlScheme, i as defu, r as createFetch } from "./dist-BA7eWeMA.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/better-auth-CKtSVGAG.js
...
function BetterAuthDemo() {
	...
	if (isPending) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-5 w-5 animate-spin rounded-full border-2 border-neutral-200 border-t-neutral-900 dark:border-neutral-800 dark:border-t-neutral-100" })
	});
	if (session?.user) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
						...
						children: ["You're signed in as ", session.user.email]
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-3",
					children: [session.user.image ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					className: "text-xs text-center text-neutral-400 dark:text-neutral-500",
					children: [
						"Built with",
						" ",
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					className: "text-lg font-semibold leading-none tracking-tight",
					children: isSignUp ? "Create an account" : "Sign in"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-sm text-neutral-500 dark:text-neutral-400 mt-2 mb-6",
					children: isSignUp ? "Enter your information to create an account" : "Enter your email below to login to your account"
				}),
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							children: loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "h-4 w-4 animate-spin rounded-full border-2 border-neutral-400 border-t-white dark:border-neutral-600 dark:border-t-neutral-900" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Please wait" })]
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					className: "mt-6 text-xs text-center text-neutral-400 dark:text-neutral-500",
					children: [
						"Built with",
						" ",
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
...
//#endregion
export { BetterAuthDemo as component };
